 ...
 */
func Av_chroma_location_enum_to_pos(xpos *int32, ypos *int32, pos AVChromaLocation) int32 {
    return int32(C.av_chroma_location_enum_to_pos((*C.int)(unsafe.Pointer(xpos)), 
 ...
 * @param ypos  vertical   chroma sample position
 */
func Av_chroma_location_pos_to_enum(xpos int32, ypos int32) AVChromaLocation {
    return AVChromaLocation(C.av_chroma_location_pos_to_enum(C.int(xpos), 
        C.int(ypos)))
}
