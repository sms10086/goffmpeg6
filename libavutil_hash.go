 ...
 */
func Av_hash_alloc(ctx **AVHashContext, name *byte) int32 {
    return int32(C.av_hash_alloc((**C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
 ...
 */
func Av_hash_names(i int32) string {
 ...
 */
func Av_hash_get_name(ctx *AVHashContext) string {
    return C.GoString(C.av_hash_get_name(
 ...
 */
func Av_hash_init(ctx *AVHashContext)  {
    C.av_hash_init((*C.struct_AVHashContext)(unsafe.Pointer(ctx)))
}
 ...
 */
func Av_hash_update(ctx *AVHashContext, src *uint8, len uint64)  {
    C.av_hash_update((*C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
 ...
 */
func Av_hash_final(ctx *AVHashContext, dst *uint8)  {
    C.av_hash_final((*C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
 ...
 */
func Av_hash_final_bin(ctx *AVHashContext, dst *uint8, size int32)  {
    C.av_hash_final_bin((*C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
        (*C.uchar)(unsafe.Pointer(dst)), C.int(size))
}
 ...
 */
func Av_hash_final_hex(ctx *AVHashContext, dst *uint8, size int32)  {
    C.av_hash_final_hex((*C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
        (*C.uchar)(unsafe.Pointer(dst)), C.int(size))
}
 ...
 * @param[in]     size Maximum number of bytes to write to `dst`
 */
func Av_hash_final_b64(ctx *AVHashContext, dst *uint8, size int32)  {
    C.av_hash_final_b64((*C.struct_AVHashContext)(unsafe.Pointer(ctx)), 
        (*C.uchar)(unsafe.Pointer(dst)), C.int(size))
}
 ...
 */
func Av_hash_freep(ctx **AVHashContext)  {
